...
public class metodo4 {
  ...
  public void crearMatrizA(int x, int y) throws IOException {
    ...
    /* Realizar todo lo siguiente desde aqui ya que este metodo crearMatriz es
     * el unico llamado */
  ...
  public int[][] transpuestaDeMatrizA(int[][] matriz) {
    ...
    int columnas =
        matriz[0].length; // Se obtiene la longitud de la fila, y representa el
    ...
    // se devuelve la matriz transpuesta hacia matrizA1, que se usa en
    // imprimirMatrizA
