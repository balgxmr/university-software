// Richard Herranz E-8-192057, Jose Encalada 8-999-1420, Jonathan Nunez
// 4-23-1010
        ...
        if (option == 1) { // RECTANGULO
          ...
          while (ciclo2) {
            ...
            if ((lado1 + lado2 > lado3 && lado2 + lado3 > lado1 &&
              ...
              area = Math.sqrt((perimetro / 2) * ((perimetro / 2) - lado1) *
                               ((perimetro / 2) - lado2) *
                               ((perimetro / 2) - lado3));
              ...
              System.out.println(
                  "Sus lados del triangulo no son correctos ingreselos nuevamente\n");
            }
