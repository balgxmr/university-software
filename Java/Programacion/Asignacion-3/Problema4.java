  ...
  public static void main(String[] args) throws Exception {
    ...
    while (ciclo) {
      try {
        ...
        System.out.println("Zapatos - " + zapatosPrecio + " - " +
                           zapatosCantidad);
        System.out.println("Carteras - " + carterasPrecio + " - " +
                           carterasCantidad);
        System.out.println("Vestidos - " + vestidosPrecio + " - " +
                           vestidosCantidad);
        System.out.println("Sombreros - " + sombrerosPrecio + " - " +
                           sombrerosCantidad);
        ...
        // Costo total
        System.out.println("El costo total para pagar los productos es: " +
                           costoTotal);
        System.out.println(
