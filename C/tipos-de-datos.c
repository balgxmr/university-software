...
int main(){
    char a = 'e'; // tamaño = 1 byte ; Rango: 0...255 // El elemento "e" se está almacenando dentro de la variable "a" que es de tipo char/caracter.
    ...
    double g = 1204912.412512; //tamaño = 8 bytes; Rango: 1.7*10 a 1.7*10
        printf("El elemento es: %lf",g); // %lf para double g (long float) // Si se pone %.lf se eliminarían todos los decimales y pasaría a ser de flotante a numero entero.
    return 0;
}