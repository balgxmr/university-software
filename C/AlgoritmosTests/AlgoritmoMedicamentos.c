/*
[1]: Descuentos especiales todos los días para los jubilados del 30% (Mujeres
mayores de 58 años y hombres mayores de 60 años). [2]: Para el resto del
público, si sus compras son mayores a 40.00 dólares, los lunes habrá descuento
del 5%, los martes del 10%, los miércoles del 15%. Para el resto de días
(jueves, viernes, sábado y domingo) no habrá descuento.

Algunas condiciones:
- Se considerará el valor 1 para el femenino, el 2 para masculino.
- Deberá utilizar la estructura mientras.
- Las iteraciones deben ser controladas por el usuario, no se permite preguntar
la cantidad de iteraciones al inicio.
