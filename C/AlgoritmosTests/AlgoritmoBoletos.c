...
float resultado, precioNeto, impuesto, descuento, PrecioNetoDesc,
    ManejoAdministrativo, totalImpuestos, totalPagar;
int zonas, boletos, boletosVip, boletosGold, boletosSilver, boletosGeneral, x;
// Bloque de construcción
int main() {
  printf("Bienvenido. \nEl boleto para la zona VIP tiene un costo de 200$; en "
         "la zona Gold = 120$; en la zona silver = 80$; y en la zona general = "
         "45$. \n");
  x = 1;
  boletosVip = 0;
  boletosGold = 0;
  ...
  while (x == 1) {
    ...
    case 1:
      printf(
          "Ingrese la cantidad de boletos que desea comprar en la zona VIP: ");
      scanf("%i", &boletos);
    ...
    case 2:
      printf(
          "Ingrese la cantidad de boletos que desea comprar en la zona GOLD: ");
      scanf("%i", &boletos);
    ...
    case 3:
      printf("Ingrese la cantidad de boletos que desea comprar en la zona "
             "SILVER: ");
      scanf("%i", &boletos);
    ...
    printf("\n¿Desea comprar boletos en otra zona? \nIntroduzca 1 si desea "
           "continuar, introduzca 0 para no comprar mas boletos: ");
    scanf("%i", &x);
  }
  ...
  printf("\nLa cantidad de boletos en la Zona GENERAL es de: %i",
         boletosGeneral);
  printf("\n---------------------------------------");
  ...
  printf("\nEl total a pagar (boletos + impuestos + manejo administrativo) es "
         "de: %.2f$",
         totalPagar);
}
